...
#ifndef RTW_HEADER_Tanks_Template_h_
#define RTW_HEADER_Tanks_Template_h_
#include <string.h>
#ifndef Tanks_Template_COMMON_INCLUDES_
#define Tanks_Template_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#endif                                 /* Tanks_Template_COMMON_INCLUDES_ */

#include "Tanks_Template_types.h"
...
#define Tanks_Template_rtModel         RT_MODEL_Tanks_Template_T
...
typedef struct {
  ...
  real_T HILReadAnalog1_Buffer[2];     /* '<Root>/HIL Read Analog1' */
...
#define rtB                            Tanks_Template_B
#define BlockIO                        B_Tanks_Template_T
#define rtX                            Tanks_Template_X
#define ContinuousStates               X_Tanks_Template_T
#define rtXdot                         Tanks_Template_XDot
#define StateDerivatives               XDot_Tanks_Template_T
#define tXdis                          Tanks_Template_XDis
#define StateDisabled                  XDis_Tanks_Template_T
#define rtP                            Tanks_Template_P
#define Parameters                     P_Tanks_Template_T
#define rtDWork                        Tanks_Template_DW
#define D_Work                         DW_Tanks_Template_T

/* Parameters (default storage) */
struct P_Tanks_Template_T_ {
  ...
  real_T C[4];                         /* Variable: C
                                        * Referenced by: '<Root>/State-Space'
                                        */
  real_T gain_1;                       /* Variable: gain_1
                                        * Referenced by: '<Root>/Gain1'
                                        */
  real_T gain_2;                       /* Variable: gain_2
                                        * Referenced by: '<Root>/Gain'
                                        */
  real_T offset_1;                     /* Variable: offset_1
                                        * Referenced by: '<Root>/Constant1'
                                        */
  real_T offset_2;                     /* Variable: offset_2
                                        * Referenced by: '<Root>/Constant2'
                                        */
  real_T v_pump;                       /* Variable: v_pump
                                        * Referenced by: '<Root>/Constant'
                                        */
  uint32_T HILWriteAnalog1_channels; /* Mask Parameter: HILWriteAnalog1_channels
                                      * Referenced by: '<Root>/HIL Write Analog1'
                                      */
  uint32_T HILReadAnalog1_channels[2];/* Mask Parameter: HILReadAnalog1_channels
  ...
  boolean_T HILReadAnalog1_Active;  /* Computed Parameter: HILReadAnalog1_Active
                                     * Referenced by: '<Root>/HIL Read Analog1'
                                     */
  uint8_T ToHostFile1_file_name[30];   /* Expression: file_name_argument
                                        * Referenced by: '<Root>/To Host File1'
                                        */
...
struct tag_RTM_Tanks_Template_T {
  const char_T *path;
...
extern P_Tanks_Template_T Tanks_Template_P;

/* Block signals (default storage) */
extern B_Tanks_Template_T Tanks_Template_B;

/* Continuous states (default storage) */
extern X_Tanks_Template_T Tanks_Template_X;

/* Block states (default storage) */
extern DW_Tanks_Template_T Tanks_Template_DW;

/* Model entry point functions */
extern void Tanks_Template_initialize(void);
extern void Tanks_Template_output(void);
extern void Tanks_Template_update(void);
extern void Tanks_Template_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern Tanks_Template_rtModel *Tanks_Template(void);
...
extern RT_MODEL_Tanks_Template_T *const Tanks_Template_M;
 ...
 * '<Root>' : 'Tanks_Template'
 */
#endif                                 /* RTW_HEADER_Tanks_Template_h_ */
