###########################################################################
## Makefile generated for component 'Tanks_Template'. 
## 
## Makefile     : Tanks_Template.mk
## Generated on : Tue Mar 17 15:13:46 2026
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\Tanks_Template.rt-win64
...
COMPILER_COMMAND_FILE     = Tanks_Template_comp.rsp
CMD_FILE                  = Tanks_Template.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\Tanks_Template.rt-win64
...
DEFINES_STANDARD = -DMODEL=Tanks_Template -DNUMST=3 -DNCSTATES=2 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)\Tanks_Template_quarc_win64\Tanks_Template.c $(START_DIR)\Tanks_Template_quarc_win64\Tanks_Template_data.c $(START_DIR)\Tanks_Template_quarc_win64\Tanks_Template_main.c $(START_DIR)\Tanks_Template_quarc_win64\rtGetInf.c $(START_DIR)\Tanks_Template_quarc_win64\rtGetNaN.c $(START_DIR)\Tanks_Template_quarc_win64\rt_nonfinite.c $(MATLAB_ROOT)\rtw\c\src\rt_sim.c C:\QUARC\quarc\src\ext_svr.c C:\QUARC\quarc\src\updown.c C:\QUARC\quarc\src\ext_work.c
...
OBJS = Tanks_Template.obj Tanks_Template_data.obj Tanks_Template_main.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj rt_sim.obj ext_svr.obj updown.obj ext_work.obj
...
LIBS = C:\QUARC\lib\win64\hil.lib C:\QUARC\lib\win64\quanser_runtime.lib C:\QUARC\lib\win64\quanser_common.lib
...
{$(START_DIR)\Tanks_Template_quarc_win64}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\Tanks_Template_quarc_win64}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
Tanks_Template.obj : $(START_DIR)\Tanks_Template_quarc_win64\Tanks_Template.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\Tanks_Template_quarc_win64\Tanks_Template.c


Tanks_Template_data.obj : $(START_DIR)\Tanks_Template_quarc_win64\Tanks_Template_data.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\Tanks_Template_quarc_win64\Tanks_Template_data.c


Tanks_Template_main.obj : $(START_DIR)\Tanks_Template_quarc_win64\Tanks_Template_main.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\Tanks_Template_quarc_win64\Tanks_Template_main.c


rtGetInf.obj : $(START_DIR)\Tanks_Template_quarc_win64\rtGetInf.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\Tanks_Template_quarc_win64\rtGetInf.c


rtGetNaN.obj : $(START_DIR)\Tanks_Template_quarc_win64\rtGetNaN.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\Tanks_Template_quarc_win64\rtGetNaN.c


rt_nonfinite.obj : $(START_DIR)\Tanks_Template_quarc_win64\rt_nonfinite.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\Tanks_Template_quarc_win64\rt_nonfinite.c
...
ext_svr.obj : C:\QUARC\quarc\src\ext_svr.c
	$(CC) $(CFLAGS) -Fo"$@" C:\QUARC\quarc\src\ext_svr.c


updown.obj : C:\QUARC\quarc\src\updown.c
	$(CC) $(CFLAGS) -Fo"$@" C:\QUARC\quarc\src\updown.c


ext_work.obj : C:\QUARC\quarc\src\ext_work.c
	$(CC) $(CFLAGS) -Fo"$@" C:\QUARC\quarc\src\ext_work.c
